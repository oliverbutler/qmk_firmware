...
[_SYMBOLS] = LAYOUT(
  ...
  _______ , KC_EXLM , KC_DQT  , KC_LCBR , KC_RCBR , KC_HASH ,                         KC_PLUS , KC_LPRN , KC_RPRN , KC_QUES , KC_EQL  , KC_BSLS,
  _______ , _______ , _______ , KC_ASTR , KC_BSLS , KC_PERC , _______ ,     _______ , _______ , KC_DLR  , _______ , _______ , KC_SLSH , _______,
                      _______ , _______ , _______ , _______ , _______ ,     _______ , _______ , _______ , _______ , _______
)
};
