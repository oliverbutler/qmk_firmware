...
[_NUM] = LAYOUT(
  ...
  _______ , _______ , _______ , _______ , _______ , _______ , KC_PASS_STR ,     _______ , _______ , _______ , KC_MEDIA_PREV_TRACK , KC_MEDIA_NEXT_TRACK , _______ , _______,
...
[_SYMBOLS] = LAYOUT(
  ...
  _______ , KC_TILD , KC_LABK , KC_RABK , _______ , _______ ,                         KC_UNDS , KC_MINS , KC_LBRC , KC_RBRC , _______ , _______,
  _______ , KC_EXLM , _______ , KC_LCBR , KC_RCBR , KC_HASH ,                         KC_PLUS , KC_LPRN , KC_RPRN , KC_QUES , KC_EQL  , KC_BSLS,
  _______ , _______ , _______ , KC_ASTR , KC_BSLS , KC_PERC , _______ ,     _______ , _______ , _______ , _______ , _______ , KC_SLSH , _______,
                      _______ , _______ , _______ , _______ , _______ ,     _______ , _______ , _______ , _______ , _______
)
,
...
//    ├──────┼──────────┼──────────┼──────────┼──────────┼─────┼──────────┐   ┌───────────────────┼──────┼──────────┼──────────┼──────────┼──────────┼────┤
//    │ LCTL │    z     │    x     │    c     │    v     │  b  │   mute   │   │       mply        │  n   │    m     │    ,     │    .     │    /     │ no │
//    └──────┴──────────┼──────────┼──────────┼──────────┼─────┼──────────┤   ├───────────────────┼──────┼──────────┼──────────┼──────────┼──────────┴────┘
...
[_GAME] = LAYOUT(
  ...
  KC_LCTL , KC_Z        , KC_X        , KC_C        , KC_V        , KC_B   , KC_MUTE  ,     KC_MEDIA_PLAY_PAUSE  , KC_N    , KC_M        , KC_COMM     , KC_DOT      , KC_SLSH        , XXXXXXX,
                          KC_LGUI   , KC_LALT     , TG(_GAME)     , KC_SPC , XXXXXXX ,      KC_ENT                 , KC_BSPC , XXXXXXX     , XXXXXXX     , KC_GRV
)
};
